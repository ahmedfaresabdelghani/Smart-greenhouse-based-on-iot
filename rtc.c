...
u16 BCD_TO_DECIMAL(u8 Copy_u8Number){
	u16 Local_Num=0;
	if((u16)Copy_u8Number<=9){
		Local_Num=(u16)Copy_u8Number;
	}
	else if((u16)Copy_u8Number>15&&(u16)Copy_u8Number<25){
		Local_Num=(u16)Copy_u8Number-6;

	}
	else if((u16)Copy_u8Number>25&&(u16)Copy_u8Number<35){
		Local_Num=(u16)Copy_u8Number-12;

	}
	else if((u16)Copy_u8Number==49||(u16)Copy_u8Number==48){
		Local_Num=(u16)Copy_u8Number-18;

	}
	else if((u16)Copy_u8Number>63&&(u16)Copy_u8Number<=73){
		Local_Num=(u16)Copy_u8Number-24;

	}
	else if((u16)Copy_u8Number>79&&(u16)Copy_u8Number<=89){
		Local_Num=(u16)Copy_u8Number-30;
